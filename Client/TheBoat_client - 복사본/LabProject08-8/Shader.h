...
public:
	...
	virtual void Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera, bool playerready[4]) {}
...
//////////////////////
class CDustShader : public CTexturedShader
{
protected:
	CBillboard * *m_ppBullet = 0;
	int								m_nBullet = 0;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class CChatReadyShader : public CTexturedShader
{
protected:
	CRotatingObject * *m_ppTree = 0;
	int								m_nTree = 0;
...
class CPlayerNameShader : public CTexturedShader
{
protected:
	CRotatingObject * *m_ppTree = 0;
	int								m_nTree = 1;
...
class CBloodScreenShader : public CTexturedShader
{
protected:
	CRotatingObject * *m_ppTree = 0;
	int								m_nTree = 1;
...
class CBloodScreenShader_1 : public CTexturedShader
{
protected:
	CRotatingObject * *m_ppTree = 0;
	int								m_nTree = 1;
...
public:
	CBloodScreenShader_1();
	virtual ~CBloodScreenShader_1();
