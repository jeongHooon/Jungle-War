...
void CCamera::SetLook(XMFLOAT3 & vLook)
{
	m_xmf3Look = vLook;
}
...
void CThirdPersonCamera::Update(XMFLOAT3& xmf3LookAt, float fTimeElapsed)
{
	if (m_pPlayer)
	{
		...
		XMFLOAT3 xmf3Right = m_pPlayer->GetRightVector();
		XMFLOAT3 xmf3Up = m_pPlayer->GetLookVector(); 
		XMFLOAT3 xmf3Look = XMFLOAT3(-m_pPlayer->GetUpVector().x, -m_pPlayer->GetUpVector().y, -m_pPlayer->GetUpVector().z);
