...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CBillboardMesh::CBillboardMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, float fWidth, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 6;
	m_nStride = sizeof(CTexturedVertex);
	m_nOffset = 0;
...
CDotMesh::CDotMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, float fWidth, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	...
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-1.0, 1.0, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(1.0, 1.0, 0), XMFLOAT2(1.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(1.0, -1.0, 0), XMFLOAT2(1.0f, 1.0f));


	pVertices[i++] = CTexturedVertex(XMFLOAT3(-1.0, 1.0, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(1.0, -1.0, 0), XMFLOAT2(1.0f, 1.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-1.0, -1.0, 0), XMFLOAT2(0.0f, 1.0f));
...
CMiniMapMesh::CMiniMapMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, float fWidth, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 6;
	m_nStride = sizeof(CTexturedVertex);
	m_nOffset = 0;
	...
	pVertices[i++] = CTexturedVertex(XMFLOAT3(1.0, -0.7, 0), XMFLOAT2(1.0f, 1.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(0.7, -0.7, 0), XMFLOAT2(0.0f, 1.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(0.7, -1.0, 0), XMFLOAT2(0.0f, 0.0f));
...
CAlphaMapMesh::CAlphaMapMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, float fWidth, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 6;
	m_nStride = sizeof(CTexturedVertex);
	m_nOffset = 0;
	...
	pVertices[i++] = CTexturedVertex(XMFLOAT3(0.7, 1.0, 0), XMFLOAT2(1.0f, 1.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.7, 1.0, 0), XMFLOAT2(0.0f, 1.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.7, -1.0, 0), XMFLOAT2(0.0f, 0.0f));

	pVertices[i++] = CTexturedVertex(XMFLOAT3(0.7, 1.0, 0), XMFLOAT2(1.0f, 1.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.7, -1.0, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(0.7, -1.0, 0), XMFLOAT2(1.0f, 0.0f));
...
CChatReadyMesh::CChatReadyMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, int index, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 6;
	m_nStride = sizeof(CTexturedVertex);
	m_nOffset = 0;
...
CItemUIMesh::CItemUIMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, int index, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	...
	pVertices[i++] = CTexturedVertex(XMFLOAT3(startXposition, -0.6, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(startXposition + 0.2, -0.6, 0), XMFLOAT2(1.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(startXposition + 0.2, -0.8, 0), XMFLOAT2(1.0f, 1.0f));


	pVertices[i++] = CTexturedVertex(XMFLOAT3(startXposition, -0.6, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(startXposition + 0.2, -0.8, 0), XMFLOAT2(1.0f, 1.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(startXposition, -0.8, 0), XMFLOAT2(0.0f, 1.0f));
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CGunUIMesh::CGunUIMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, int index, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 6;
	m_nStride = sizeof(CTexturedVertex);
	m_nOffset = 0;
	...
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-1.0, -0.7 + 0.2 * index, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.6, -0.7 + 0.2 * index, 0), XMFLOAT2(1.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.6, -0.98 + 0.2 * index, 0), XMFLOAT2(1.0f, 1.0f));


	pVertices[i++] = CTexturedVertex(XMFLOAT3(-1.0, -0.7 + 0.2 * index, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.6, -0.98 + 0.2 * index, 0), XMFLOAT2(1.0f, 1.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-1.0, -0.98 + 0.2 * index, 0), XMFLOAT2(0.0f, 1.0f));
...
CGunUIMesh::~CGunUIMesh()
{
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CNumMesh::CNumMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, int index, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 6;
	m_nStride = sizeof(CTexturedVertex);
	m_nOffset = 0;
...
CMainScreenMesh::CMainScreenMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, int index, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 6;
	m_nStride = sizeof(CTexturedVertex);
	m_nOffset = 0;
	...
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-1, 1, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(1, 1, 0), XMFLOAT2(1.0f, 0.0f));
...
CMainScreenMesh::~CMainScreenMesh()
{
}

CMainScreenCheckMesh::CMainScreenCheckMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, int index, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 6;
	m_nStride = sizeof(CTexturedVertex);
	m_nOffset = 0;
	...
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.5, -0.1, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(0.5, -0.1, 0), XMFLOAT2(1.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(0.5, -0.3, 0), XMFLOAT2(1.0f, 1.0f));

	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.5, -0.1, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(0.5, -0.3, 0), XMFLOAT2(1.0f, 1.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.5, -0.3, 0), XMFLOAT2(0.0f, 1.0f));
...
CMainScreenCheckMesh::~CMainScreenCheckMesh()
{
}

CMainScreenCheck_1Mesh::CMainScreenCheck_1Mesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, int index, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 6;
	m_nStride = sizeof(CTexturedVertex);
	m_nOffset = 0;
	...
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.3, -0.4, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(0.3, -0.4, 0), XMFLOAT2(1.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(0.3, -0.6, 0), XMFLOAT2(1.0f, 1.0f));

	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.3, -0.4, 0), XMFLOAT2(0.0f, 0.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(0.3, -0.6, 0), XMFLOAT2(1.0f, 1.0f));
	pVertices[i++] = CTexturedVertex(XMFLOAT3(-0.3, -0.6, 0), XMFLOAT2(0.0f, 1.0f));
...
CMainScreenCheck_1Mesh::~CMainScreenCheck_1Mesh()
{
}

CCubeMesh::CCubeMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, float fWidth, float fHeight, float fDepth) : CMeshTextured(pd3dDevice, pd3dCommandList)
{
	m_nVertices = 36;
	m_nStride = sizeof(CIlluminatedTexturedVertex);
	m_nOffset = 0;
